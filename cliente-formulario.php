            ...
            <div class="col-12">
                <div class="card mb-3">
                    ...
                    <div class="panel-body">
                        <div class="col">
                            <select class="form-control my-4" name="lstProvincia" id="lstProvincia">

                            <option selected disabled value="<?php echo $cliente->fk_idprovincia; ?>"><?php echo $cliente->nombreprovincia? $cliente->nombreprovincia : "Provincia";  ?></option>
                        ...
                        <div class="col">
                            <input type="text" class="form-control" name="txtLocalidad" id="txtLocalidad" placeholder="Localidad" value="<?php echo $cliente->localidad; ?>">
                        </div>
                        <div class="col my-4">
                            <input type="text" class="form-control" name="txtDomicilio" id="txtDomicilio" placeholder="Domicilio" value="<?php echo $cliente->domicilio ?>">
                        </div>
                    </div>
                </div>
            </div>
